					...
					<form class="" action="{{ action('PacienteController@createPaciente') }}" method="post" id="form-create-paciente">
						...
						<div class="row">
							<div class="col-md-12 form-group">
								...
								<input class="form-control" type="text" name="nome_paciente" id="nome-paciente" value="Paulo da Costa Silva Santos" placeholder="Paulo da Costa Silva Santos">
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-4 form-group">
								...
								<input class="form-control" type="date" name="data_nascimento" id="data-nascimento" value="1997-09-15">
							</div>
							<div class="col-md-4 form-group">
								<label>Número do CNS:<span class="vermelho">*</span></label>
								<input class="form-control" type="text" name="numero_cns" id="numero_cns" value="013456789012345" placeholder="2000.1234.9890.9893">
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 form-group">
								<label>CPF (Opcional):</label>
								<input class="form-control" type="text" name="cpf" id="cpf" value="00012389018" placeholder="000.123.890-98">
							</div>
							<div class="col-md-6 form-group">
								<label>RG (Opcional):</label>
								<input class="form-control" type="text" name="rg" id="rg" value="12345678905" placeholder="12345678901">
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 form-group">
								<label>Nome da Mãe:<span class="vermelho">*</span></label>
								<input class="form-control" type="text" name="nome_mae" id="nome-mae" value="Maria da Silva Pereira" placeholder="Maria da Silva Pereira">
							</div>
							<div class="col-md-6 form-group">
								<label>Nome da Pai (Opcional):</label>
								<input class="form-control" type="text" name="nome_pai" id="nome-pai" value="Francisco Pereira" placeholder="Francisco Pereira">
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6 form-group">
								...
								<input type="text" name="telefone_um" id="telefone-um" placeholder="(88)99999-9988" value="999999912" class="form-control">
							</div>
							<div class="col-md-6 form-group">
								<label>Telefone Adicional (Opicional):</label>
								<input type="text" name="telefone_dois" id="telefone-dois" placeholder="(88)99999-9988" value="999999932" class="form-control">
							</div>
						</div>
						<div class="row">
							<hr>
